function [output, state] = pretraineddLungmaskFcn_R231(input, params, varargin)
%PRETRAINEDDLUNGMASKFCN_R231 Function implementing an imported ONNX network.
%
...
%
% [OUTPUT] = pretraineddLungmaskFcn_R231(INPUT, PARAMS)
%			- Evaluates the imported ONNX network PRETRAINEDDLUNGMASKFCN_R231 with input(s)
%			INPUT and the imported network parameters in PARAMS. Returns
%			network output(s) in OUTPUT.
%
% [OUTPUT, STATE] = pretraineddLungmaskFcn_R231(INPUT, PARAMS)
%			- Additionally returns state variables in STATE. When training,
%			use this form and set TRAINING to true.
%
% [__] = pretraineddLungmaskFcn_R231(INPUT, PARAMS, 'NAME1', VAL1, 'NAME2', VAL2, ...)
...
if Training
    [Vars.x230, dsmean, dsvar] = batchnorm(Vars.x229, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.down_path_0_block_2_running_mean = dlarray(dsmean);
    Vars.down_path_0_block_2_running_var = dlarray(dsvar);
else
    Vars.x230 = batchnorm(Vars.x229, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
if Training
    [Vars.x233, dsmean, dsvar] = batchnorm(Vars.x232, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.down_path_0_block_5_running_mean = dlarray(dsmean);
    Vars.down_path_0_block_5_running_var = dlarray(dsvar);
else
    Vars.x233 = batchnorm(Vars.x232, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
% Pad:
[Vars.x234, NumDims.x234] = onnxPad(Vars.x233, Vars.PadPadding1007, 0.000000, 'constant', dlarray([0:NumDims.x233]'), NumDims.x233);
...
if Training
    [Vars.x238, dsmean, dsvar] = batchnorm(Vars.x237, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.down_path_1_block_2_running_mean = dlarray(dsmean);
    Vars.down_path_1_block_2_running_var = dlarray(dsvar);
else
    Vars.x238 = batchnorm(Vars.x237, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
if Training
    [Vars.x241, dsmean, dsvar] = batchnorm(Vars.x240, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.down_path_1_block_5_running_mean = dlarray(dsmean);
    Vars.down_path_1_block_5_running_var = dlarray(dsvar);
else
    Vars.x241 = batchnorm(Vars.x240, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
% Pad:
[Vars.x242, NumDims.x242] = onnxPad(Vars.x241, Vars.PadPadding1017, 0.000000, 'constant', dlarray([0:NumDims.x241]'), NumDims.x241);
...
if Training
    [Vars.x246, dsmean, dsvar] = batchnorm(Vars.x245, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.down_path_2_block_2_running_mean = dlarray(dsmean);
    Vars.down_path_2_block_2_running_var = dlarray(dsvar);
else
    Vars.x246 = batchnorm(Vars.x245, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
if Training
    [Vars.x249, dsmean, dsvar] = batchnorm(Vars.x248, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.down_path_2_block_5_running_mean = dlarray(dsmean);
    Vars.down_path_2_block_5_running_var = dlarray(dsvar);
else
    Vars.x249 = batchnorm(Vars.x248, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
% Pad:
[Vars.x250, NumDims.x250] = onnxPad(Vars.x249, Vars.PadPadding1027, 0.000000, 'constant', dlarray([0:NumDims.x249]'), NumDims.x249);
...
if Training
    [Vars.x254, dsmean, dsvar] = batchnorm(Vars.x253, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.down_path_3_block_2_running_mean = dlarray(dsmean);
    Vars.down_path_3_block_2_running_var = dlarray(dsvar);
else
    Vars.x254 = batchnorm(Vars.x253, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
if Training
    [Vars.x257, dsmean, dsvar] = batchnorm(Vars.x256, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.down_path_3_block_5_running_mean = dlarray(dsmean);
    Vars.down_path_3_block_5_running_var = dlarray(dsvar);
else
    Vars.x257 = batchnorm(Vars.x256, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
% Pad:
[Vars.x258, NumDims.x258] = onnxPad(Vars.x257, Vars.PadPadding1037, 0.000000, 'constant', dlarray([0:NumDims.x257]'), NumDims.x257);
...
if Training
    [Vars.x262, dsmean, dsvar] = batchnorm(Vars.x261, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.down_path_4_block_2_running_mean = dlarray(dsmean);
    Vars.down_path_4_block_2_running_var = dlarray(dsvar);
else
    Vars.x262 = batchnorm(Vars.x261, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
if Training
    [Vars.x265, dsmean, dsvar] = batchnorm(Vars.x264, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.down_path_4_block_5_running_mean = dlarray(dsmean);
    Vars.down_path_4_block_5_running_var = dlarray(dsvar);
else
    Vars.x265 = batchnorm(Vars.x264, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
% Shape:
[Vars.x271, NumDims.x271] = onnxShape(Vars.x270, NumDims.x270, 0, NumDims.x270+1);

% Gather:
[Vars.x273, NumDims.x273] = onnxGather(Vars.x271, Vars.x272, 0, NumDims.x271, NumDims.x272);

% Shape:
[Vars.x274, NumDims.x274] = onnxShape(Vars.x270, NumDims.x270, 0, NumDims.x270+1);

% Gather:
[Vars.x276, NumDims.x276] = onnxGather(Vars.x274, Vars.x275, 0, NumDims.x274, NumDims.x275);

% Shape:
[Vars.x277, NumDims.x277] = onnxShape(Vars.x257, NumDims.x257, 0, NumDims.x257+1);

% Gather:
[Vars.x279, NumDims.x279] = onnxGather(Vars.x277, Vars.x278, 0, NumDims.x277, NumDims.x278);

% Shape:
[Vars.x280, NumDims.x280] = onnxShape(Vars.x257, NumDims.x257, 0, NumDims.x257+1);
...
% Cast:
if islogical(Vars.x285)
    Vars.x285 = single(Vars.x285);
end
Vars.x286 = cast(int64(extractdata(Vars.x285)), 'like', Vars.x285);
NumDims.x286 = NumDims.x285;

% Cast:
if islogical(Vars.x286)
    Vars.x286 = single(Vars.x286);
end
...
% Cast:
if islogical(Vars.x290)
    Vars.x290 = single(Vars.x290);
end
Vars.x291 = cast(int64(extractdata(Vars.x290)), 'like', Vars.x290);
NumDims.x291 = NumDims.x290;

% Cast:
if islogical(Vars.x291)
    Vars.x291 = single(Vars.x291);
end
...
if Training
    [Vars.x310, dsmean, dsvar] = batchnorm(Vars.x309, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.up_path_0_conv_block_block_2_running_mea = dlarray(dsmean);
    Vars.up_path_0_conv_block_block_2_running_var = dlarray(dsvar);
else
    Vars.x310 = batchnorm(Vars.x309, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
if Training
    [Vars.x313, dsmean, dsvar] = batchnorm(Vars.x312, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.up_path_0_conv_block_block_5_running_mea = dlarray(dsmean);
    Vars.up_path_0_conv_block_block_5_running_var = dlarray(dsvar);
else
    Vars.x313 = batchnorm(Vars.x312, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
% Shape:
[Vars.x319, NumDims.x319] = onnxShape(Vars.x318, NumDims.x318, 0, NumDims.x318+1);

% Gather:
[Vars.x321, NumDims.x321] = onnxGather(Vars.x319, Vars.x320, 0, NumDims.x319, NumDims.x320);

% Shape:
[Vars.x322, NumDims.x322] = onnxShape(Vars.x318, NumDims.x318, 0, NumDims.x318+1);

% Gather:
[Vars.x324, NumDims.x324] = onnxGather(Vars.x322, Vars.x323, 0, NumDims.x322, NumDims.x323);

% Shape:
[Vars.x325, NumDims.x325] = onnxShape(Vars.x249, NumDims.x249, 0, NumDims.x249+1);

% Gather:
[Vars.x327, NumDims.x327] = onnxGather(Vars.x325, Vars.x326, 0, NumDims.x325, NumDims.x326);

% Shape:
[Vars.x328, NumDims.x328] = onnxShape(Vars.x249, NumDims.x249, 0, NumDims.x249+1);
...
% Cast:
if islogical(Vars.x333)
    Vars.x333 = single(Vars.x333);
end
Vars.x334 = cast(int64(extractdata(Vars.x333)), 'like', Vars.x333);
NumDims.x334 = NumDims.x333;

% Cast:
if islogical(Vars.x334)
    Vars.x334 = single(Vars.x334);
end
...
% Cast:
if islogical(Vars.x338)
    Vars.x338 = single(Vars.x338);
end
Vars.x339 = cast(int64(extractdata(Vars.x338)), 'like', Vars.x338);
NumDims.x339 = NumDims.x338;

% Cast:
if islogical(Vars.x339)
    Vars.x339 = single(Vars.x339);
end
...
if Training
    [Vars.x358, dsmean, dsvar] = batchnorm(Vars.x357, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.up_path_1_conv_block_block_2_running_mea = dlarray(dsmean);
    Vars.up_path_1_conv_block_block_2_running_var = dlarray(dsvar);
else
    Vars.x358 = batchnorm(Vars.x357, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
if Training
    [Vars.x361, dsmean, dsvar] = batchnorm(Vars.x360, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.up_path_1_conv_block_block_5_running_mea = dlarray(dsmean);
    Vars.up_path_1_conv_block_block_5_running_var = dlarray(dsvar);
else
    Vars.x361 = batchnorm(Vars.x360, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
% Shape:
[Vars.x367, NumDims.x367] = onnxShape(Vars.x366, NumDims.x366, 0, NumDims.x366+1);

% Gather:
[Vars.x369, NumDims.x369] = onnxGather(Vars.x367, Vars.x368, 0, NumDims.x367, NumDims.x368);

% Shape:
[Vars.x370, NumDims.x370] = onnxShape(Vars.x366, NumDims.x366, 0, NumDims.x366+1);

% Gather:
[Vars.x372, NumDims.x372] = onnxGather(Vars.x370, Vars.x371, 0, NumDims.x370, NumDims.x371);

% Shape:
[Vars.x373, NumDims.x373] = onnxShape(Vars.x241, NumDims.x241, 0, NumDims.x241+1);

% Gather:
[Vars.x375, NumDims.x375] = onnxGather(Vars.x373, Vars.x374, 0, NumDims.x373, NumDims.x374);

% Shape:
[Vars.x376, NumDims.x376] = onnxShape(Vars.x241, NumDims.x241, 0, NumDims.x241+1);
...
% Cast:
if islogical(Vars.x381)
    Vars.x381 = single(Vars.x381);
end
Vars.x382 = cast(int64(extractdata(Vars.x381)), 'like', Vars.x381);
NumDims.x382 = NumDims.x381;

% Cast:
if islogical(Vars.x382)
    Vars.x382 = single(Vars.x382);
end
...
% Cast:
if islogical(Vars.x386)
    Vars.x386 = single(Vars.x386);
end
Vars.x387 = cast(int64(extractdata(Vars.x386)), 'like', Vars.x386);
NumDims.x387 = NumDims.x386;

% Cast:
if islogical(Vars.x387)
    Vars.x387 = single(Vars.x387);
end
...
if Training
    [Vars.x406, dsmean, dsvar] = batchnorm(Vars.x405, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.up_path_2_conv_block_block_2_running_mea = dlarray(dsmean);
    Vars.up_path_2_conv_block_block_2_running_var = dlarray(dsvar);
else
    Vars.x406 = batchnorm(Vars.x405, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
if Training
    [Vars.x409, dsmean, dsvar] = batchnorm(Vars.x408, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.up_path_2_conv_block_block_5_running_mea = dlarray(dsmean);
    Vars.up_path_2_conv_block_block_5_running_var = dlarray(dsvar);
else
    Vars.x409 = batchnorm(Vars.x408, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
% Shape:
[Vars.x415, NumDims.x415] = onnxShape(Vars.x414, NumDims.x414, 0, NumDims.x414+1);

% Gather:
[Vars.x417, NumDims.x417] = onnxGather(Vars.x415, Vars.x416, 0, NumDims.x415, NumDims.x416);

% Shape:
[Vars.x418, NumDims.x418] = onnxShape(Vars.x414, NumDims.x414, 0, NumDims.x414+1);

% Gather:
[Vars.x420, NumDims.x420] = onnxGather(Vars.x418, Vars.x419, 0, NumDims.x418, NumDims.x419);

% Shape:
[Vars.x421, NumDims.x421] = onnxShape(Vars.x233, NumDims.x233, 0, NumDims.x233+1);

% Gather:
[Vars.x423, NumDims.x423] = onnxGather(Vars.x421, Vars.x422, 0, NumDims.x421, NumDims.x422);

% Shape:
[Vars.x424, NumDims.x424] = onnxShape(Vars.x233, NumDims.x233, 0, NumDims.x233+1);
...
% Cast:
if islogical(Vars.x429)
    Vars.x429 = single(Vars.x429);
end
Vars.x430 = cast(int64(extractdata(Vars.x429)), 'like', Vars.x429);
NumDims.x430 = NumDims.x429;

% Cast:
if islogical(Vars.x430)
    Vars.x430 = single(Vars.x430);
end
...
% Cast:
if islogical(Vars.x434)
    Vars.x434 = single(Vars.x434);
end
Vars.x435 = cast(int64(extractdata(Vars.x434)), 'like', Vars.x434);
NumDims.x435 = NumDims.x434;

% Cast:
if islogical(Vars.x435)
    Vars.x435 = single(Vars.x435);
end
...
if Training
    [Vars.x454, dsmean, dsvar] = batchnorm(Vars.x453, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.up_path_3_conv_block_block_2_running_mea = dlarray(dsmean);
    Vars.up_path_3_conv_block_block_2_running_var = dlarray(dsvar);
else
    Vars.x454 = batchnorm(Vars.x453, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
if Training
    [Vars.x457, dsmean, dsvar] = batchnorm(Vars.x456, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
    Vars.up_path_3_conv_block_block_5_running_mea = dlarray(dsmean);
    Vars.up_path_3_conv_block_block_5_running_var = dlarray(dsvar);
else
    Vars.x457 = batchnorm(Vars.x456, offset, scale, datasetMean, datasetVariance, 'Epsilon', 1.000000e-05, 'DataFormat', dataFormat);
end
...
% Function to validate inputs to pretraineddLungmaskFcn_R231:
p = inputParser;
